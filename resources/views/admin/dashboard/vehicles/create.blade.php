...
@section('title', 'Add Vehicle - RideShare Dashboard')
...
<div class="max-w-2xl mx-auto">
    <div class="card bg-white rounded-lg p-6">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-xl font-semibold text-gray-900">Add New Vehicle</h2>
            <a href="{{ route('admin.vehicles.index') }}" class="text-blue-500 hover:text-blue-600">
        ...
        <form action="{{ route('admin.vehicles.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="driver_id" class="block text-sm font-medium text-gray-700 mb-2">Assign Driver</label>
